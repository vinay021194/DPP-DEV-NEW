...
        return fetch('/assets/demo/data/icis_forecast_summary_table.json').then(res => res.json()).then(d => d.Sheet1);
...
        return fetch('/assets/demo/data/supplierData.json').then(res => res.json()).then(d => console.log("d===>",d));
...
        return fetch('/assets/demo/data/plantData.json').then(res => res.json()).then(d => d.Sheet1);
