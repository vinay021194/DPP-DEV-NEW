...
export default class ProcService {
  ...
  getIcisForecastErrorInfoUpdated(params) {
    return axios
      ...
      .then((res) => res)
      .catch((e) => console.log(`error in getIcisForecastErrorInfoUpdated ${e.message}`));
  }
  ...
  getIcisForecastSummaryTable(params) {
    return axios
      .get("/assets/demo/data/icis_forecast_summary_table.json", { params: params })
      .then((res) => res)
  ...
  getOrder(params) {
    return axios
      .get("/assets/demo/data/order.json", { params: params })
      .then((res) => res)
