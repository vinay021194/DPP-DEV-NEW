...
// }, []);
  ...
  const header = (
    <div className="table-header-container">
      <h5 style={{ fontWeight: "bolder", fontFamily: "poppins" }}>Demand Prediction</h5>
    </div>
  );
  const headers = (
    <div className="table-header-container">
  ...
  return (
    <div>
      ...
      <div className="layout-main">
        <div className="card">
        <DataTable  value={products3.Sheet3}
                   // expandedRows={expandedRows} 
                    onRowToggle={(e) => setExpandedRows(e.data)}
                    onRowExpand={onRowExpand} onRowCollapse={onRowCollapse} responsiveLayout="scroll"
                    rowExpansionTemplate={rowExpansionTemplate} dataKey="" header={header}      rows={1}>
        ...
        <div className="card">
          ...
          <div className="">
          <h5 style={{ fontWeight: "bolder", fontFamily: "poppins",display:'flex',justifyContent:'center' }}>Average yearly Consumption</h5>
          </div>
          <DataTable
           style={{ width:'30%' ,display:'flex',justifyContent:'center' ,marginLeft:'35%'}}
            value={products2.Sheet3}
            dataKey="id"
            rows={2}
          >
