...
export const MaterialForm = () => {
  ...
  return (
    <div className="form-demo">
      ...
      <div className="p-d-flex p-jc-center">
        <div className="card">
          <h5 className="p-text-center" style={{ fontWeight: "bolder", fontFamily: "revert" }}>
            Please Enter Buyer Purchasing Group
          </h5>
          <form onSubmit={formik.handleSubmit} className="p-fluid">
            <div className="p-field">
              <span className="p-float-label">
                <Dropdown id="country" name="country" value={country} onChange={handleChange} options={countries} optionLabel="name" />
